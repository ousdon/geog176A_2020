...
gifski::save_gif({
  for(i in 0:20) {
    ...
    build_flood = offset_sb
    tmp[tmp > i] = NA
    cols2 = ifelse(!is.na(raster::extract(Flood_offset, buildings_poly)), "red", "black")
...
plot(Flood_offset, add = TRUE, col2 = rev(blues9))
